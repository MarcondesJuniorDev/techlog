                ...
                <div class="hidden items-center space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="center" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('admin.awards.index') }}">
                                {{ __('Prêmios') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden items-center space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="center" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('admin.course.categories.index') }}">
                                {{ __('Categorias') }}
                            </x-dropdown-link>
                            ...
                            <x-dropdown-link href="{{ route('admin.school.year.index') }}">
                                {{ __('Anos Letivos') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                ...
                <ul class="mt-2 space-y-1 px-4">
                    <li>
                        <a href="{{ route('admin.news.index') }}" class="block px-4 py-2 border-l-4 border-transparent border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Notícias') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.banners.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Banners') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.slides.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Slides') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.awards.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Prêmios') }}
                        </a>
                    </li>
                </ul>
            ...
            <details class="group [&_summary::-webkit-details-marker]:hidden">
                ...
                <ul class="mt-2 space-y-1 px-4">
                    <li>
                        <a href="{{ route('admin.lessons.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Aulas') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.grades.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Séries') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.courses.index') }}" class="block px-4 py-2 border-l-4 border-transparent border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Cursos') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.course.categories.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Categorias') }}
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.school.year.index') }}" class="block px-4 py-2 border-l-4 border-transparent text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out flex cursor-pointer items-center justify-between">
                            {{ __('Anos Letivos') }}
                        </a>
                    </li>
                </ul>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-responsive-nav-link href="{{ route('site.home') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Site') }}
                </x-responsive-nav-link>
